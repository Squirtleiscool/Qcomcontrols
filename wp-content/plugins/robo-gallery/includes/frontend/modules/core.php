...
class roboGalleryModuleCore{
	...
	public function init(){
		$this->config 		= new roboGalleryModuleConfigV1( $this );
		
		$this->cache 		= new roboGalleryModuleCache( $this );
		$this->cacheDB 		= new roboGalleryModuleCacheDB( $this );

		$this->modules['resize'] 		= new roboGalleryModuleResize( $this );

		$this->source 		= new roboGalleryModuleSourceV1( $this );

		$this->jsOptions 	= new roboGalleryModuleJsOptionsV1( $this );
		$this->scssCompiler = new roboGalleryScss( $this );
		$this->element 		= new roboGalleryModuleElement( $this );
		$this->assets 		= new roboGalleryModuleAssetsV1( $this );
		...
		$this->modules['size.v1'] 		= new roboGalleryModuleSize( $this );
		
		$this->modules['loader.v1'] 		= new roboGalleryModuleloader( $this );
